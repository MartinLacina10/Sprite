...
public class Game {
    ...
    static private final FloatBuffer bfr = BufferUtils.createFloatBuffer(8);
    static float index = 0f;

    static private final float[] vertices = {
            0.2f, 0.3f, 0.0f, //right top
            0.2f, -0.3f, 0.0f, //right bottom
            -0.2f, -0.3f, 0.0f, //left bottom
            -0.2f, 0.3f, 0.0f,//left top
    };
    ...
    static int squareVboId = GL33.glGenBuffers();
    static int squareEboId = GL33.glGenBuffers();
    static int colorsId = GL33.glGenBuffers();
    ...
    public static void update() {
        ...
        GL33.glBufferData(GL33.GL_ARRAY_BUFFER, bfr, GL33.GL_STATIC_DRAW);
        GL33.glVertexAttribPointer(2, 2, GL33.GL_FLOAT, false, 0, 0);
        GL33.glEnableVertexAttribArray(2);
    }
    ...
    public static void changeSpritePos(){
        textures[0] = (index+1)/6;
        textures[2] = (index+1)/6;
        textures[4] = index/6;
        textures[6] = index/6;
        index++;
        if(index==6){
